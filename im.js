...
;(function(window, undefined){
    ...
    var im = {
        ...
        , fillFace: function(){//fill faces in face-wrapper
            var faceStr = '';
        ...
        , init: function(){
            ...
            //set kefu name
            this.title.html(easemobConfig.sdkconfig.to);
        ...
        , notSupport: function(){
            this.chatwrapper.append("<label class='e-failed'>您的浏览器不支持发送图片</label>");
            this.scrollBottom();
        }
