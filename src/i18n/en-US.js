module.exports = {
	...
	common: {
		...
		file_permissions: "The program needs to access your file permission. Is it allowed?",
		video_permissions: "The program needs access to your photos and albums. Is it allowed?",
		allow: "Allow",
		refuse: "Refuse",
		Hangup: "Hang up",
		accept: "Accept",
