app.initGetGreetings = (function (_const, utils, profile, eventListener, apiHelper, channel){
	return function(){
...
}(easemobim._const, easemobim.utils, app.profile, app.eventListener, app.apiHelper, app.channel));
